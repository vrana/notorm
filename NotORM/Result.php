...
*/
class Result extends NotORMAbstract implements \Iterator, \ArrayAccess, \Countable {
	protected $single;
	...
	* @return Row inserted row or false in case of an error or number of affected rows for INSERT ... SELECT
	*/
